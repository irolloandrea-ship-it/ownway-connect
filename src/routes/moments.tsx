...
export const Route = createFileRoute("/moments")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "OwnWay Moments reward the advice that actually made a trip better — not the loudest traveler or biggest influencer." },
      { property: "og:title", content: "OwnWay Moments — The advice that changes the trip" },
      { property: "og:description", content: "The one piece of advice that made your trip better, smoother, richer, or more memorable." },
      { property: "og:url", content: "https://ownway-connect.lovable.app/moments" },
    ],
    links: [{ rel: "canonical", href: "https://ownway-connect.lovable.app/moments" }],
  }),
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="container-page py-20 md:py-28">
        ...
        <div className="mt-20 grid gap-10 md:grid-cols-2 md:gap-16 items-center">
