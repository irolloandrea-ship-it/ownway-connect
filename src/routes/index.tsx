          ...
          <div className="grid items-center gap-12 lg:grid-cols-[55fr_45fr] lg:gap-10">
            ...
            <div className="relative lg:min-h-[720px]">
              <img
                ...
                className="aspect-[4/3] w-full rounded-3xl object-cover object-center shadow-card sm:aspect-[3/2] lg:absolute lg:inset-y-16 lg:left-0 lg:aspect-auto lg:h-[calc(100%-8rem)] lg:w-[76%]"
              />
